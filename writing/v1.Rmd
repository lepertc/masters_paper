...
An effect of previous matches on present matches could affect how matches are played. If player's know that long matches hurt them in the long run, they might work harder to win quickly. Of course, we also need to measure the long run effect of working harder before making such a suggestion.
...
Where
\begin{itemize}
    \item $k$ is the maximum number of goal. 9 for home teams and 6 for visitor teams.
...
stargazer(m43, m45, single.row = TRUE, header = FALSE, table.placement = "H", 
          covariate.labels = c("Diff. in ranking points",
                               ...
                               "4 Set - PMLD (hours)",
                               "5 Set - PMLD (hours)"),
          column.labels = c("Best of 3", "Best of 5"),  font.size = "footnotesize",
...
Carlos Lago Penas and Andrzej Soroka. "The effect of a succession of matches on the physical performance of elite football players during the world cup brazil 2014". _Inter-national Journal of Performance Analysis in Sport_, 16(2):434–441, 2016.
...
Karlis Dimitris and Ioannis Ntzoufras. "Analysis of sports data using bivariate poisson models." _Journal of the Royal Statistical Society: Series D (The Statistician)_ ,52(3):381–393, 2003

Klaassen, Franc J. G. M. and Jan R. Magnus. “Forecasting the winner of a tennis match.” _European Journal of Operational Research_, 148(2003):257-267.

Maher M. J. "Modeling association football scores." _Statistica Neerlandica_, 36(3):109–118, 1982.
